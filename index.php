        ...
        <!--<div class="section-content">-->
            <!--<div class="row">-->
                <!--<div class="col-md-12 text-center">-->
                    ...
                    <!--<p class="section-subtitle">Here is what and how I do.</p>-->
            ...
            <!--&lt;!&ndash; PORTFOLIO START &ndash;&gt;-->
            <!--<div class="portfolio">-->
                <!--<div class="row">-->
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            <!--&lt;!&ndash;<div class="project-link">-->
                                <!--<a class="zoom" title="Buzz Lightyear">-->
                            ...
                            <!--<img src="assets/images/Code4-Write-Less-Code-Effectiently.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/adaptability1.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/Extensible.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/Efficient-1.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/ClearAndConcise.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/Security.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/BugFree2.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
                    ...
                    <!--<div class="item col-sm-6 col-md-3">-->
                        <!--<div class="project-wrapper">-->
                            ...
                            <!--<img src="assets/images/tdd.jpg" alt="" class="img-responsive"/>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; //.project-wrapper &ndash;&gt;-->
                    <!--</div>-->
                    <!--&lt;!&ndash; //.item &ndash;&gt;-->
